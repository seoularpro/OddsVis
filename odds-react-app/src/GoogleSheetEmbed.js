...
const GoogleSheetStyled = () => {
  ...
  const getCellStyle = (cell) => {
    ...
    const bgColor =
      backgroundColor && !isWhiteBackground
        ? `rgba(${backgroundColor.red * 255 || 0}, ${
            backgroundColor.green * 255 || 0
          }, ${backgroundColor.blue * 255 || 0}, ${backgroundColor.alpha || 1})`
  ...
  return (
    <div>
      ...
      >
        Trade values disabled until we have more information.
      </h1>
      <h2
        style={{
          textAlign: "left",
      ...
      >
        Values are based on a $200 auction draft budget so multiple trade values
        should add up to the value of a single player.
      </h2>
